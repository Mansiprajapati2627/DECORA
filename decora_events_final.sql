...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2025 at 03:06 PM
...
CREATE TABLE `bookings` (
  ...
  `decoration_title` varchar(255) DEFAULT NULL,
...
CREATE TABLE `customizations` (
  `id` int(11) NOT NULL,
  `customization_id` varchar(20) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
...
--
ALTER TABLE `customizations`
  ADD CONSTRAINT `customizations_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
